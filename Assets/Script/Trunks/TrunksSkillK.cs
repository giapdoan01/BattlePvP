...
public class TrunksSkillK : MonoBehaviour, ISkill
{
    [Header("Dash Settings")]
    [SerializeField] private AudioSource SkillKAudioSource;
    [SerializeField] private AudioClip SkillKSound;
    ...
    private IEnumerator ExecuteDash()
    {
        ...
        // Thực hiện dash
        float elapsedTime = 0;
        if (SkillKAudioSource != null && SkillKSound != null)
        {
            SkillKAudioSource.PlayOneShot(SkillKSound);
        }

...
public class TrunksSkillL : MonoBehaviour, ISkill
{
    ...
    public float lifeTime = 1f; // thời gian hitbox tồn tại
    public float moveSpeed = 10f; // Tốc độ di chuyển (units/giây) để đạt 10 units trong 0.3 giây
